<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Formularios/General.Master" CodeBehind="FrmGenAlimentacionCorteros.aspx.vb" Inherits="CCCReportes.FrmGenAlimentacionCorteros" %>
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        <td class="auto-style6">
                            <asp:TextBox ID="txtZafraID" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style14">
                            <asp:TextBox ID="txtPeriodoID" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
