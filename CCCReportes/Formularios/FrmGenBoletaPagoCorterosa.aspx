    ...
    Protected Sub btnExportarReporte_Click(sender As Object, e As EventArgs) Handles btnExportarReporte.Click
        ...
        Select Case rbFormat.SelectedItem.Value
            ...
            Case "PDF"
                ...
                cr.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, "C:\Users\jcabrera\Desktop\PDF")
               ' MsgBox("Documento guardado exitosamente", MsgBoxStyle.Information, "Maria Montessori")
            Case "Excel"
        ...
        '               Response,
        '               Adjunto,
        '               "Boleta de Pago de Corteros_" & txtPeriodoID.Text)
