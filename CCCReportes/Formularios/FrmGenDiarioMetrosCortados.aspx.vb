...
Public Class FrmGenDiarioMetrosCortados
    ...
    Public Function ProcesarReporteParametros2(crystalReport1 As ReportDocument) As ReportDocument
        Try
            Dim report As New Diario_de_Metros_Cortados()
            ...
            crystalReport1.SetParameterValue(1, cbxFrenteID.SelectedItem.Value)
            crystalReport1.SetParameterValue(2, txtPeriodoID.Text)
            crystalReport1.SetParameterValue(3, txtCantLineas.Text)
            crystalReport1.SetParameterValue(4, "0")
    ...
    Protected Sub btnExportarReporte_Click(sender As Object, e As EventArgs) Handles btnExportarReporte.Click
        ...
        crystalReport.ExportToHttpResponse(formatType,
                       Response,
                       False,
                       "Diario_Metros_Cortados_Frente_[" & cbxFrenteID.Text & "]_" & txtPeriodoID.Text)
