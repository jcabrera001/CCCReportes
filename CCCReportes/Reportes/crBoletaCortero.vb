...
Public Class crBoletaCortero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CCCReportes.crBoletaCortero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrBoletaCortero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBoletaCortero = New crBoletaCortero()
        rpt.Site = Me.Site
        Return rpt
    End Function
